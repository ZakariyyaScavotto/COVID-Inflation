...
def compileMetrics(metricsDict, loadModel):
    ...
    if loadModel:
        ...
        trainingMetrics.to_excel("Metrics/LoadedTrainingMetrics.xlsx")
        testingMetrics.to_excel("Metrics/LoadedTestingMetrics.xlsx")
    else:
        ...
        trainingMetrics.to_excel("Metrics/NewTrainingMetrics.xlsx")
        testingMetrics.to_excel("Metrics/NewTestingMetrics.xlsx")
