...
def makeTrainTest(modelName, window, testWindow, secondTime=False): # Train test but with breaking up between pre-2020 and 2020->beyond
    ...
    econData = readEconData("C:/Users/zs811/OneDrive/Documents/CodingProjectsStuff/2023SummerResearch-Inflation/COVID-Inflation/Data/ConstructedDataframes/INTERPAllEcon1990AndCOVIDWithLags.xlsx")
...
def trainEvalNN(window, testWindow, loadModel=False):
    if not loadModel:
        ...
        with open("InterpModels/NNRevBestHyperparams.txt", "w") as f:
        ...
        for epoch in range(1, 100 + 1):
            ...
            if epochError < bestError:
                ...
                torch.save({'model_state_dict': model.state_dict(), 
                    ...
                    'batch_size': analysis.best_config["batch"]},"InterpModels/NNRevModel.pt")
        ...
        with open("InterpModels/NNRevBestHyperparams.txt", "r") as f:
        ...
        checkpoint = torch.load("InterpModels/NNRevModel.pt")
        ...
        for epoch in range(1, 100 + 1):
            ...
            if epochError < bestError:
                ...
                torch.save({'model_state_dict': model.state_dict(), 
                    'optimizer_state_dict': optimizer.state_dict(),
                    'batch_size': batch_size},"InterpModels/NNRevModel.pt")
            elif epoch - bestEpoch >= earlyStopThresh:
                print("Early stopping at epoch "+str(epoch))
                break
        # print the model weights
