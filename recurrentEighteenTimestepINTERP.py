...
timestep = 18 # number of timesteps to look back
...
def main():
    ...
    train.to_excel("Metrics/eighteenMonthTimestepTrainINTERP.xlsx")
    test.to_excel("Metrics/eighteenMonthTimestepTestINTERP.xlsx")
    print("Program Done")
    mainPlotting()
