...
def makeTrainTest(modelName, window, testWindow, secondTime=False): # Train test but with breaking up between pre-2020 and 2020->beyond
    # Read econ data
    econData = readEconData("Data/ConstructedDataframes/AllEcon1990AndCOVIDWithLagsDynamic.xlsx")
...
def main():
    ...
    train.to_excel("Metrics/rollingTrainMetricsDynamic.xlsx")
    test.to_excel("Metrics/rollingTestMetricsDynamic.xlsx")
    print("Program Done")
    # mainPlotting()
